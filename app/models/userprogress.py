...
class UserProgress(BaseModel, table=True):
    ...
    status: UserProgressStatus = Field(default=UserProgressStatus.NOT_STARTED, nullable=False)
    grade: Optional[float] = Field(default=None, sa_column=Column(Numeric(5, 2), nullable=True))
