...
from sqlalchemy import DateTime, Text, Numeric, Integer
...
class User(SQLModel, table=True):
    ...
    role: UserRole
    created_at: Optional[datetime] = Field(column=Column(DateTime, server_default=func.now()))
...
class Course(SQLModel, table=True):
    ...
    career_track_courses: List["CareerTrackCourse"] = Relationship(back_populates="course")
...
class Prerequisite(SQLModel, table=True):
    ...
    course: Course = Relationship(back_populates="prerequisites", 
                                  foreign_keys="Prerequisite.course_id")
    prerequisite_course: Course = Relationship(foreign_keys="Prerequisite.prerequisite_course_id")
