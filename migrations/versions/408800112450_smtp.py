...
account_status_enum = sa.Enum('CREATED', 'CONFIRMED', 'BLOCKED', name='accountstatus')
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            'subject', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False
        ),
        sa.Column(
    ...
    op.add_column('users', sa.Column('status', account_status_enum, nullable=False))
